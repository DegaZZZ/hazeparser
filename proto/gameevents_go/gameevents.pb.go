...
type CMsgPlaceDecalEvent struct {
	...
	Position             *networkbasetypes_go.CMsgVector `protobuf:"bytes,1,opt,name=position" json:"position,omitempty"`
	Normal               *networkbasetypes_go.CMsgVector `protobuf:"bytes,2,opt,name=normal" json:"normal,omitempty"`
	Saxis                *networkbasetypes_go.CMsgVector `protobuf:"bytes,3,opt,name=saxis" json:"saxis,omitempty"`
...
func (x *CMsgPlaceDecalEvent) GetPosition() *networkbasetypes_go.CMsgVector {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *CMsgPlaceDecalEvent) GetNormal() *networkbasetypes_go.CMsgVector {
	if x != nil {
		return x.Normal
	}
	return nil
...
func (x *CMsgPlaceDecalEvent) GetSaxis() *networkbasetypes_go.CMsgVector {
	if x != nil {
		return x.Saxis
	}
	return nil
...
var file_gameevents_proto_rawDesc = []byte{
	...
	0x01, 0x42, 0x16, 0x5a, 0x14, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x61, 0x6d, 0x65,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x5f, 0x67, 0x6f,
}
...
var file_gameevents_proto_goTypes = []any{
	...
	(*networkbasetypes_go.CMsgVector)(nil),            // 17: CMsgVector
}
